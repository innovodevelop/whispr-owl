...
const ChatWindow = ({ 
  ...
  return (
    <div className={cn("flex flex-col h-full rounded-l-2xl p-4", className)} style={{ backgroundColor: 'hsl(224deg 51.69% 7.79% / 95%)' }}>
      {/* Chat Header */}
      ...
      {/* Messages Area */}
      <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-4" style={{ backgroundColor: 'hsl(var(--background) / 0.95)' }}>
        {loading ? (
      ...
      {/* Message Input */}
      <div className="p-3 md:p-4 bg-card/60 backdrop-blur-xl border border-border/50 rounded-xl border-t border-border/30 slide-up mb-16 md:mb-0">
        <div className="flex items-center gap-2">
          <BurnOnReadSelector
